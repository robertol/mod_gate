MRuby::Toolchain.new(:gcc) do |conf|
  [conf.cc, conf.objc, conf.asm].each do |cc|
    ...
    cc.flags = [ENV['CFLAGS'] || %w(-g -std=gnu99 -ggdb -fPIC -Wall -Werror-implicit-function-declaration -Wdeclaration-after-statement)]
  ...
  [conf.cxx].each do |cxx|
    ...
    cxx.flags = [ENV['CXXFLAGS'] || ENV['CFLAGS'] || %w(-g -ggdb -fPIC -Wall -Werror-implicit-function-declaration)]
